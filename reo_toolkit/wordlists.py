...
ambiguous = make_wordlist(
    os.path.join(os.path.dirname(__file__), "ambiguous_terms.txt")
)
non_maori = make_wordlist(
    os.path.join(os.path.dirname(__file__), "non_maori_terms.txt")
)
